  ...
  return (
    <section className="w-full flex flex-col gap-6 sm:grid sm:grid-cols-3 justify-center items-center px-6 sm:px-[20%] mb-10 sm:mb-0">
      ...
      {APP_FEATURES.map((feature, index) => (
        <Card key={index} className="col-span-1 flex flex-col justify-center items-center p-6 min-h-[14.5rem] border-gray-400 hover:border-gray-800 hover:shadow-lg group">
          {feature.icon}
